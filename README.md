...
- `content-index`: emits the sitemap, RSS feed, and explicitly configured JSON content index.
...
- `figures`: renders image captions, comparisons, and the shared figure carousel.
