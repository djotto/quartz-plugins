...
> This plugin preserves the upstream Quartz Community plugin while fixing single-weight Google
> Fonts requests. The upstream project is
> [quartz-community/fonts](https://github.com/quartz-community/fonts).
...
```bash
npx quartz plugin add https://github.com/djotto/quartz-plugins --subdir plugins/fonts
```
